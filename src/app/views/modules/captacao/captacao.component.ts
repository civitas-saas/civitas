  ...
  template: `
    <div class="space-y-6 max-w-4xl mx-auto py-10 animate-fade-in font-sans">
      <div class="bg-slate-900/40 border border-slate-800/80 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
        <!-- Glow design -->
        <div class="absolute -right-16 -top-16 w-32 h-32 rounded-full bg-emerald-500/5 blur-xl"></div>
        ...
        <h1 class="text-2xl font-bold text-white mb-2">Captação de Recursos</h1>
        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 mb-6">
          Estrutura Preparada
        </span>
        
        <p class="text-slate-400 text-sm max-w-lg mx-auto mb-8 leading-relaxed">
          Gerencie e planeje as fontes de receita da sua instituição. Registre doações físicas e jurídicas, transações recorrentes via Pix ou boleto, repasses de termos de fomento e organize campanhas de financiamento coletivo.
        </p>
